 ...
 */
package guia_3_ejericicio7_rs232;
 ...
 * @author berna
 */
public class Guia_3_ejericicio7_RS232 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Ingrese una cadena de texto (cuando desee salir ingrese &&&&&)");
        ...
        System.out.println("La cantidad de lecturas correctas es de: " + lecturasCorrectas + ("\n") + "La cantidad de lecturas incorrectas es de: " + lecturasIncorrectas);
    }
